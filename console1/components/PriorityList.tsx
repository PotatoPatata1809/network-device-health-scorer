    ...
    <div>
      ...
      <table className="w-full text-[13.5px] border-collapse">
        ...
        <tbody>
          ...
          {list.length === 0 && (
            <tr><td colSpan={5} className="py-8 px-3 text-mut text-center">
              No devices yet. Run <span className="font-mono">discover</span> in the
              Terminal — or use ▶ Run demo → Discover the network.
            </td></tr>
          )}
        </tbody>
      </table>
